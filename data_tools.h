...
{
  /*
    The input file is suppose to contain data corresponding
    to different depths in the soil. We are expecting the 
    'data' file to contain as first line the corresponding
    depths.
    So, the total size of the file is 'date_and_time.size()' + 1
    We take this into account when the data and dates are
    printed to 'outFile' by adding a string to 'date_and_time':
    "Date\tTime". So that the final file look something like:
    
    Date  Time  Depth1  Depth2  ...
    00/00/00  00:00:00  0.0  0.0  ...
    ...
  */
  //  if(data.size() != date_and_time.size()+1)
  ...
  for (unsigned int i=0; i<(unsigned int)lines_to_print; i++)
	...
	outFile << std::setw(2) << std::setfill('0') << date_and_time[i-1][0] << "/" 
		<< std::setw(2) << std::setfill('0') << date_and_time[i-1][1] << "/" 
		<< std::setw(2) << std::setfill('0') << date_and_time[i-1][2] << "\t"
		<< std::setw(2) << std::setfill('0') << date_and_time[i-1][3] << ":" 
		<< std::setw(2) << std::setfill('0') << date_and_time[i-1][4] << ":" 
		<< std::setw(2) << std::setfill('0') << date_and_time[i-1][5];
      ...
      for (unsigned int j = 0; j<data[0].size(); j++)
	{
	  if(fabs(data[i][j])<0.001)
	    ...
	    outFile << "\t" << std::setw(7) << std::setfill(' ') << std::setprecision(3) << std::fixed << data[i][j];
	}
      outFile << "\n";
    }
}
...
/*
  ...
  Then this vectors are return by specific functions within the class.
...
Names::Names ()
{
  ...
  */  
  bh_A_temperatures.push_back ("./input/trl_borehole_data/borehole_A_average_data/average_borehole_A_05_09.txt");
  bh_A_temperatures.push_back ("./input/trl_borehole_data/borehole_A_average_data/average_borehole_A_05_10.txt");
  bh_A_temperatures.push_back ("./input/trl_borehole_data/borehole_A_average_data/average_borehole_A_05_11.txt");
  bh_A_temperatures.push_back ("./input/trl_borehole_data/borehole_A_average_data/average_borehole_A_05_12.txt");
  bh_A_temperatures.push_back ("./input/trl_borehole_data/borehole_A_average_data/average_borehole_A_06_01.txt");
  bh_A_temperatures.push_back ("./input/trl_borehole_data/borehole_A_average_data/average_borehole_A_06_02.txt");
  bh_A_temperatures.push_back ("./input/trl_borehole_data/borehole_A_average_data/average_borehole_A_06_03.txt");
  bh_A_temperatures.push_back ("./input/trl_borehole_data/borehole_A_average_data/average_borehole_A_06_04.txt");
  bh_A_temperatures.push_back ("./input/trl_borehole_data/borehole_A_average_data/average_borehole_A_06_05.txt");
  bh_A_temperatures.push_back ("./input/trl_borehole_data/borehole_A_average_data/average_borehole_A_06_06.txt");
  bh_A_temperatures.push_back ("./input/trl_borehole_data/borehole_A_average_data/average_borehole_A_06_07.txt");
  bh_A_temperatures.push_back ("./input/trl_borehole_data/borehole_A_average_data/average_borehole_A_06_08.txt");
  /*
    Metereological data from Met Office
  */
  met_data_met_office.push_back ("/home/c1045890/input/met_data/met_office/met_office_2005_09.txt"); // 0
  met_data_met_office.push_back ("/home/c1045890/input/met_data/met_office/met_office_2005_10_using_2006_data.txt"); // 1
  met_data_met_office.push_back ("/home/c1045890/input/met_data/met_office/met_office_2005_11.txt"); // 2
  met_data_met_office.push_back ("/home/c1045890/input/met_data/met_office/met_office_2005_12.txt"); // 3
  met_data_met_office.push_back ("/home/c1045890/input/met_data/met_office/met_office_2006_01.txt"); // 4
  met_data_met_office.push_back ("/home/c1045890/input/met_data/met_office/met_office_2006_02.txt"); // 5
  met_data_met_office.push_back ("/home/c1045890/input/met_data/met_office/met_office_2006_03.txt"); // 6
  met_data_met_office.push_back ("/home/c1045890/input/met_data/met_office/met_office_2006_04.txt"); // 7
  met_data_met_office.push_back ("/home/c1045890/input/met_data/met_office/met_office_2006_05.txt"); // 8
  met_data_met_office.push_back ("/home/c1045890/input/met_data/met_office/met_office_2006_06.txt"); // 9
  met_data_met_office.push_back ("/home/c1045890/input/met_data/met_office/met_office_2006_07.txt"); // 10
  met_data_met_office.push_back ("/home/c1045890/input/met_data/met_office/met_office_2006_08.txt"); // 11
  met_data_met_office.push_back ("/home/c1045890/input/met_data/met_office/met_office_2006_08_up_to_day_22.txt"); // 12
  met_data_met_office.push_back ("/home/c1045890/input/met_data/met_office/hourly_average_met_office_data_from_23_08_2005_to_14_11_2005.txt"); // 13
  /*
    Metereological data from TRL
  */
  met_data_trl.push_back ("/home/c1045890/input/met_data/trl/hourly_average_met_data_05_09.txt"); // 0
  met_data_trl.push_back ("/home/c1045890/input/met_data/trl/hourly_average_met_data_05_10.txt"); // 1
  met_data_trl.push_back ("/home/c1045890/input/met_data/trl/hourly_average_met_data_05_11.txt"); // 2
  met_data_trl.push_back ("/home/c1045890/input/met_data/trl/hourly_average_met_data_05_12.txt"); // 3
  met_data_trl.push_back ("/home/c1045890/input/met_data/trl/hourly_average_met_data_06_01.txt"); // 4
  met_data_trl.push_back ("/home/c1045890/input/met_data/trl/hourly_average_met_data_06_02.txt"); // 5
  met_data_trl.push_back ("/home/c1045890/input/met_data/met_office/met_office_2006_03.txt"); // 6
  //<<-- replace this file since the correspoding TRL's is from 2007 and it seems that that year was 
  // particularly hot
  //met_data_trl.push_back ("/home/c1045890/input/met_data/trl/hourly_average_met_data_06_03.txt"); // 6
  met_data_trl.push_back ("/home/c1045890/input/met_data/trl/hourly_average_met_data_06_04.txt"); // 7
  met_data_trl.push_back ("/home/c1045890/input/met_data/trl/hourly_average_met_data_06_05.txt"); // 8
  met_data_trl.push_back ("/home/c1045890/input/met_data/trl/hourly_average_met_data_06_06.txt"); // 9
  met_data_trl.push_back ("/home/c1045890/input/met_data/trl/hourly_average_met_data_06_07.txt"); // 10
  met_data_trl.push_back ("/home/c1045890/input/met_data/met_office/met_office_2006_08.txt");     // 11
  met_data_trl.push_back ("/home/c1045890/input/met_data/met_office/met_office_2006_08_up_to_day_22.txt"); // 12
  met_data_trl.push_back ("/home/c1045890/input/met_data/trl/hourly_average_met_data_from_23_08_2005_to_14_11_2005.txt"); // 13
  met_data_trl.push_back ("/home/c1045890/input/met_data/trl/hourly_average_met_data_from_15_11_2005_to_20_02_2006.txt"); // 14
  met_data_trl.push_back ("/home/c1045890/input/met_data/trl/hourly_average_met_data_from_21_02_2006_to_26_04_2006.txt"); // 15
  met_data_trl.push_back ("/home/c1045890/input/met_data/trl/hourly_average_met_data_from_27_04_2006_to_31_10_2006.txt"); // 16
  met_data_trl.push_back ("/home/c1045890/input/met_data/trl/hourly_average_met_data_from_01_11_2006_to_28_02_2007.txt"); // 17
  /*
    DAILY averages from the BADC
  */
  met_data_badc_daily_averages.push_back("/home/c1045890/input/met_data/met_office/daily_averages_solar_air_temperature_1985.dat");
  met_data_badc_daily_averages.push_back("/home/c1045890/input/met_data/met_office/daily_averages_solar_air_temperature_1986.dat");
  met_data_badc_daily_averages.push_back("/home/c1045890/input/met_data/met_office/daily_averages_solar_air_temperature_1987.dat");
  met_data_badc_daily_averages.push_back("/home/c1045890/input/met_data/met_office/daily_averages_solar_air_temperature_1988.dat");
  met_data_badc_daily_averages.push_back("/home/c1045890/input/met_data/met_office/daily_averages_solar_air_temperature_1989.dat");
  met_data_badc_daily_averages.push_back("/home/c1045890/input/met_data/met_office/daily_averages_solar_air_temperature_1990.dat");
  met_data_badc_daily_averages.push_back("/home/c1045890/input/met_data/met_office/daily_averages_solar_air_temperature_1991.dat");
  met_data_badc_daily_averages.push_back("/home/c1045890/input/met_data/met_office/daily_averages_solar_air_temperature_1992.dat");
  met_data_badc_daily_averages.push_back("/home/c1045890/input/met_data/met_office/daily_averages_solar_air_temperature_1993.dat");
  met_data_badc_daily_averages.push_back("/home/c1045890/input/met_data/met_office/daily_averages_solar_air_temperature_1994.dat");
  met_data_badc_daily_averages.push_back("/home/c1045890/input/met_data/met_office/daily_averages_solar_air_temperature_1995.dat");
  met_data_badc_daily_averages.push_back("/home/c1045890/input/met_data/met_office/daily_averages_solar_air_temperature_1996.dat");
  met_data_badc_daily_averages.push_back("/home/c1045890/input/met_data/met_office/daily_averages_solar_air_temperature_1997.dat");
  met_data_badc_daily_averages.push_back("/home/c1045890/input/met_data/met_office/daily_averages_solar_air_temperature_1998.dat");
  met_data_badc_daily_averages.push_back("/home/c1045890/input/met_data/met_office/daily_averages_solar_air_temperature_1999.dat");
  met_data_badc_daily_averages.push_back("/home/c1045890/input/met_data/met_office/daily_averages_solar_air_temperature_2000.dat");
  met_data_badc_daily_averages.push_back("/home/c1045890/input/met_data/met_office/daily_averages_solar_air_temperature_2001.dat");
  met_data_badc_daily_averages.push_back("/home/c1045890/input/met_data/met_office/daily_averages_solar_air_temperature_2002.dat");
  met_data_badc_daily_averages.push_back("/home/c1045890/input/met_data/met_office/daily_averages_solar_air_temperature_2003.dat");
  met_data_badc_daily_averages.push_back("/home/c1045890/input/met_data/met_office/daily_averages_solar_air_temperature_2004.dat");
  met_data_badc_daily_averages.push_back("/home/c1045890/input/met_data/met_office/daily_averages_solar_air_temperature_2005.dat");
  met_data_badc_daily_averages.push_back("/home/c1045890/input/met_data/met_office/daily_averages_solar_air_temperature_2006.dat");
  // if (preheating_step==1)
  //   {
  //     // 0 - 11
  //     met_data_met_office.push_back ("/home/c1045890/input/met_data/met_office/met_office_2005_09.txt");
  //     met_data_met_office.push_back ("/home/c1045890/input/met_data/met_office/met_office_2005_10_using_2006_data.txt");
  //     met_data_met_office.push_back ("/home/c1045890/input/met_data/met_office/met_office_2005_11.txt");
  //     met_data_met_office.push_back ("/home/c1045890/input/met_data/met_office/met_office_2005_12.txt");
  //     met_data_met_office.push_back ("/home/c1045890/input/met_data/met_office/met_office_2006_01.txt");
  //     met_data_met_office.push_back ("/home/c1045890/input/met_data/met_office/met_office_2006_02.txt");
  //     met_data_met_office.push_back ("/home/c1045890/input/met_data/met_office/met_office_2006_03.txt");
  //     met_data_met_office.push_back ("/home/c1045890/input/met_data/met_office/met_office_2006_04.txt");
  //     met_data_met_office.push_back ("/home/c1045890/input/met_data/met_office/met_office_2006_05.txt");
  //     met_data_met_office.push_back ("/home/c1045890/input/met_data/met_office/met_office_2006_06.txt");
  //     met_data_met_office.push_back ("/home/c1045890/input/met_data/met_office/met_office_2006_07.txt");
  //     met_data_met_office.push_back ("/home/c1045890/input/met_data/met_office/met_office_2006_08.txt");
  //   }
  // else if (preheating_step==2)
  //   {
  //     // 0 - 7
  ...
  //     met_data_met_office.push_back ("/home/c1045890/input/met_data/met_office/met_office_2006_06.txt");
  //     met_data_met_office.push_back ("/home/c1045890/input/met_data/met_office/met_office_2006_07.txt");
  //     met_data_met_office.push_back ("/home/c1045890/input/met_data/met_office/met_office_2006_08_up_to_day_22.txt");
  //   }
  // else if (preheating_step==4)
  //   {
  //     // 13
  //     met_data_met_office.push_back ("/home/c1045890/input/met_data/met_office/hourly_average_met_office_data_from_23_08_2005_to_14_11_2005.txt");
  //   }
  // else
  //   {
  ...
  //     met_data_trl.push_back ("/home/c1045890/input/met_data/trl/hourly_average_met_data_05_09.txt");
  //     met_data_trl.push_back ("/home/c1045890/input/met_data/trl/hourly_average_met_data_05_10.txt");
  //     met_data_trl.push_back ("/home/c1045890/input/met_data/trl/hourly_average_met_data_05_11.txt");
  //     met_data_trl.push_back ("/home/c1045890/input/met_data/trl/hourly_average_met_data_05_12.txt");
  //     met_data_trl.push_back ("/home/c1045890/input/met_data/trl/hourly_average_met_data_06_01.txt");
  //     met_data_trl.push_back ("/home/c1045890/input/met_data/trl/hourly_average_met_data_06_02.txt");
  //     met_data_trl.push_back ("/home/c1045890/input/met_data/trl/hourly_average_met_data_06_03.txt");
  //     met_data_trl.push_back ("/home/c1045890/input/met_data/trl/hourly_average_met_data_06_04.txt");
  //   }
  // else if (preheating_step==3)
  //   {
  //     // SUBSET 8 9 10 , 12
  //     met_data_trl.push_back ("/home/c1045890/input/met_data/trl/hourly_average_met_data_06_05.txt"); 
  //     met_data_trl.push_back ("/home/c1045890/input/met_data/trl/hourly_average_met_data_06_06.txt");
  //     met_data_trl.push_back ("/home/c1045890/input/met_data/trl/hourly_average_met_data_06_07.txt");
  //     met_data_trl.push_back ("/home/c1045890/input/met_data/met_office/met_office_2006_08_up_to_day_22.txt");
  //   }
  // else if (preheating_step==4)
  //   {
  //     // 13
  //     met_data_trl.push_back ("/home/c1045890/input/met_data/trl/hourly_average_met_data_from_23_08_2005_to_14_11_2005.txt");
  //   }
  // else if (preheating_step==5)
  //   {
  //     // 14
  //     met_data_trl.push_back ("/home/c1045890/input/met_data/trl/hourly_average_met_data_from_15_11_2005_to_20_02_2006.txt");
  //   }
  // else if (preheating_step==6)
  //   {
  //     // 15
  //     met_data_trl.push_back ("/home/c1045890/input/met_data/trl/hourly_average_met_data_from_21_02_2006_to_26_04_2006.txt");
  //   }
  // else if (preheating_step==7)
  //   {
  //     // 16
  //     met_data_trl.push_back ("/home/c1045890/input/met_data/trl/hourly_average_met_data_from_27_04_2006_to_31_10_2006.txt");
  //   }
  // else if (preheating_step==8)
  //   {
  //     // 17
  //     met_data_trl.push_back ("/home/c1045890/input/met_data/trl/hourly_average_met_data_from_01_11_2006_to_28_02_2007.txt");
  //   }
  // else
  //   {
